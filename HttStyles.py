...
def GetStyleHtt():
  ...
  HttStyle=ROOT.TStyle("Htt-Style","The Perfect Style for Plots ;-)")

  #// Canvas
  HttStyle.SetCanvasColor     (3)
  ...
  #HttStyle.SetPalette(57)

  ##// color palette for 2D temperature plots
  ##HttStyle.SetPalette(1,0)
  ##HttStyle.SetPalette(44);
  HttStyle.SetPalette(57);
  ##stops = [0.00, 0.34, 0.61, 0.84, 1.00]
  ##stops = [0.00, 0.15, 0.25, 0.55, 1.00]
  ##red   = [0.00, 0.00, 0.87, 1.00, 0.51]
  ##green = [0.00, 0.81, 1.00, 0.20, 0.00]
  ##blue  = [0.51, 1.00, 0.12, 0.00, 0.00]
  #stops = [0.00, 0.35, 0.50, 0.80, 1.00]
  #red   = [0.00, 0.25, 0.50, 0.75, 1.00]
  #green = [0.00, 0.25, 0.50, 0.75, 1.00]
  #blue  = [0.00, 0.25, 0.50, 0.75, 1.00]

  #stops = [0.00, 0.5, 0.70, 0.80, 1.00]
  #red   = [1.00, 0.50, 0.00, 0.00, 0.00]
  #green = [1.00, 1.00, 1.00, 0.55, 0.00]
  #blue  = [0.00, 0.25, 0.50, 0.75, 1.00]
  ...
  HttStyle.SetNumberContours(999)
  ...
  HttStyle.SetTitleSize  (0.045,"Z")
  HttStyle.SetTitleOffset(0.96,"Z")
  HttStyle.SetLabelOffset(0.005,"Z")
  HttStyle.SetLabelSize  (0.040,"Z")
  HttStyle.SetLabelFont  (42   ,"Z")
  ...
  HttStyle.SetStripDecimals(ROOT.kFALSE)
  HttStyle.SetLineStyleString(11,"20 10")

  HttStyle.SetTitleSize  (0.055,"Y")
  HttStyle.SetTitleOffset(1.400,"Y")
